...
The Nonzero Sum Design Language is a part of the [Nonzero Sum Stack](https://nonzerosumsolutions.com/stack/index.html). The Nonzero Sum Stack is a set of recommended technologies and engineering processes for sustainable software development. For examples of apps built using the Stack (including Design Language) see [helloapp](https://github.com/Nonzero-Sum-Solutions/helloapp) (Go) and [helloapppy](https://github.com/Nonzero-Sum-Solutions/helloapppy) (Python).
...
```bash
go install github.com/Nonzero-Sum-Solutions/designlanguage
```
